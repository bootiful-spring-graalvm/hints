...
@Configuration
@ConditionalOnClass(name = "twitter4j.UserJSONImpl")
@ImportRuntimeHints(Twitter4jAotAutoConfiguration.Twitter4jRuntimeHintsRegistrar.class)
class Twitter4jAotAutoConfiguration {
	 ...
	 * @author Josh Long
	 */
	static class Twitter4jRuntimeHintsRegistrar implements RuntimeHintsRegistrar {
		...
		public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
			...
			reflections.getSubTypesOf(Serializable.class)
				.forEach(t -> hints.reflection().registerType(t, memberCategories));
			reflections.getSubTypesOf(TweetEntity.class)
				.forEach(t -> hints.reflection().registerType(t, memberCategories));
		}
